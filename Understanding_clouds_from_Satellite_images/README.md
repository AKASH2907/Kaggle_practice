# kaggle_salt_identification_challenge
...
In this challenge, we need to build a model to classify cloud organization patterns from satellite images. If successful, scientists can better understand how clouds will shape our future climate. This research will guide the development of next-generation models which could reduce uncertainties in climate projections.
